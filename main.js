...
function setup()
    r = Math.floor((Math.random()*array_1.length)+1)
    console.log("sketch");
    EOA = array_1[random_no]
...
function draw(){
    ...
    if(draw_sketch==sketch){
        answer_holder=set;
        score=score+1;
        document.getElementById("e1").innerHTML="score:"+score;
        }
}
function cs(){
   timer_counter=timer_counter+1;
   document.getElementById("e2").innerHTML="time:"+timer_counter;
